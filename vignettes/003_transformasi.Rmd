...
1. memilih data who
2. menggabungkan kolom menjadi pasangan key-value 
3. memilih kolom
4. mengumpulkan data berdasarkan tahun dan negara
5. menyederhanakan data dari group_by agar menjadi single value
6. membuat group dari 1 atau lebih variabel
7. left_join menggabungkan dua table
8. filter data yang hilang
9. membuat table proportion dimana yang berisi 100*kolom cases/population
